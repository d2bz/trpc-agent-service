...
本页保留此前 README 中的需求说明、交付物与验收标准。项目介绍与运行入口见[README](../README.md)，实际代码范围见[实现与验证](acceptance.md)，依赖版本及能力见[框架说明](project-foundation.md)。本页中的示范目录用于表达需求职责，实际模块以仓库源码为准。
